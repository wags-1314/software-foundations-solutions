...
Proof.
  ...
  - intros m. rewrite <- plus_n_Sm. rewrite <- IHn'. simpl. reflexivity.
Qed.
...
Lemma lemma2:
  forall a b: nat, a + b + a + b = a + a + b + b.
Proof.
  intros.
  replace (a + b + a) with (a + a + b).
  - trivial.
  - rewrite lemma1. trivial.
Qed.
...
Theorem nat_to_bin_Sn : forall n,
