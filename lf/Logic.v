...
Proof.
  ...
  - intros m H. simpl in H. split. reflexivity. apply H.
...
Proof.
  intros n.
  induction n as [| n' IHn'].
  - intros m H. destruct H as [H1 H2]. simpl. apply H2.
  - intros m H. destruct H as [H1 H2]. discriminate H1.
Qed.
...
Proof.
  intros n.
  induction n as [| n' IHn'].
  - intros m H. simpl in H. left. apply H.
  - intros m H. simpl in H. apply and_exercise in H. destruct H as [H1 H2].
    right. apply H1.
Qed.
(** [] *)
...
Definition test : Prop := forall P Q:Prop,  P -> Q.

Definition not' (P: Prop) : Prop := P -> False.

Definition function (n: nat) : nat := n * n.
  ...
  - induction l as [| x' l' IHl'].
    ...
    + simpl. intros [H | H].
      ...
      * apply IHl' in H. destruct H as [x [H1 H2]].
        ...
        -- right. apply H2.
  (* <- *)
  - intros H0. destruct H0 as [x [H1 H2]].
...
Proof.
  ...
  split.
  (* -> *)
  - induction l as [| x0 l0 IHl0].
    (* l = [] *)
    + simpl. intros. right. apply H.
    (* l = x :: l0 *)
    + simpl. intros. destruct H as [H | H].
      * left. left. apply H.
      * apply IHl0 in H. apply or_assoc. right. apply H.
  (* <- *)
  - induction l as [| x0 l0 IHl0].
    + simpl. intros. destruct H.
      * destruct H.
      * apply H.
    + simpl. intros. apply or_assoc in H. destruct H as [H | H].
      * left. apply H.
      * apply IHl0 in H. right. apply H.
Qed.
...
Proof.
  ...
  - induction l as [| x' l' IHl'].
    ...
    + intros H1 x H2. simpl in H1. simpl in H2.
...
Lemma lemma1: forall X (l: list X) (x: X),
  rev_append l [x] = rev_append l [ ] ++ [x].
Proof.
  intros X l.
  induction l.
  - simpl. reflexivity.
  - simpl. rewrite IHl. symmetry. rewrite <- app_assoc. simpl. Abort.
...
Proof.
  ...
  induction l.
  - reflexivity.
  - simpl. unfold tr_rev. simpl. rewrite <- IHl. unfold tr_rev. Abort.
...
Lemma negb_true_b_false : forall b,
    negb b = true -> b = false.
Proof.
  intros b H0.
  destruct b eqn:H1.
...
Lemma negb_false_b_true : forall b,
    negb b = false -> b = true.
Proof.
  intros b H0.
  destruct b eqn:H1.
...
Proof.
  (* Hint: Use the [evenb_S] lemma from [Induction.v]. evenb (S n) = negb (evenb n) *)
  intros n.
  induction n as [| n' IHn'].
  - exists 0. simpl. reflexivity.
  - rewrite evenb_S. destruct IHn' as [k IHn'].
    destruct (negb (evenb n')) eqn:H.
    + apply (negb_true_b_false (evenb n')) in H.
      exists (S k). simpl. f_equal. rewrite H in IHn'. apply IHn'.
    + apply (negb_false_b_true (evenb n')) in H.
      exists k. f_equal. rewrite H in IHn'. apply IHn'.
 Qed.
...
Proof.
  ...
  - intros H. destruct b1. destruct b2.
    ...
    + split. discriminate. destruct b2. reflexivity. discriminate.
  - intros. destruct b1, b2.
    + reflexivity.
    + simpl. destruct H as [H1 H2]. discriminate.
    + simpl. destruct H as [H1 H2]. discriminate.
    + simpl. destruct H as [H1 H2]. discriminate.
Qed.
  ...
  - split.
    + destruct l2 as [| x2 l2].
      ...
      * intros. simpl in H. apply andb_true_iff in H.
        destruct H as [H1 H2]. apply H0 in H1. apply IHl' in H2.
...
Proof.
  ...
  - induction l as[| x' l' IHl'].
    + simpl. reflexivity.
    + simpl. intros H0. apply andb_true_iff in H0. destruct H0 as [H0 H1].
      apply IHl' in H1. split.
      * apply H0.
      * apply H1.
  - induction l as [| x' l' IHl'].
    + simpl. intros. reflexivity.
    + simpl. intros [H1 H2]. rewrite H1. apply IHl' in H2.
      apply andb_true_iff. split.
      * reflexivity.
      * apply H2.
Qed.
...
Proof.
  ...
  - apply H.
  - exfalso. apply H0. exists x. apply H.
Qed.
...
Theorem excluded_middle_to_peirce : forall P Q: Prop,
...
Proof.
  ...
  intros A B.
  intros H.
  destruct (EM A) as [H0 | H0].
  - apply H0.
  - apply H. intros H1. unfold not in H0. apply H0 in H1. exfalso. apply H1.
Qed.

Theorem peirce_to_double_negation_elimination : forall P Q: Prop,
